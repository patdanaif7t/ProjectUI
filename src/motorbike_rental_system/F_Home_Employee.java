 ...
 * @author firstx
 */
public class F_Home_Employee extends javax.swing.JFrame {

    /**
     * Creates new form F_Home_Employee
     */
    public F_Home_Employee() {
        initComponents();
        showDate();
        showTime();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Home_Employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_Home_Employee().setVisible(true);
            }
        });
    }
